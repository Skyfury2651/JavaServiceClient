 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://service.springservice.example.com/", wsdlLocation = "http://localhost:8088/ws/student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://service.springservice.example.com/", "StudentServiceService");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://service.springservice.example.com/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.springservice.example.com/", "StudentServicePort"), StudentService.class, features);
    }
